    ...
    <div class="col-10 mx-auto">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            @if (Auth::user()->is_admin == 1)
                <a style="padding: 5px 15px;" href="{{ route('salns.admin') }}" class="btn btn-primary btn-danger" type="button"><i class="fas fa-chevron-left"></i> Back</a>
            @else
                ...
                <div class="row">
                    ...
                    <div class="col mb-4">
                        ...
                        <div class="input-group" id="datepicker2">
                            <input type="text" class="form-control" placeholder="M dd, yyyy" data-date-format="M dd, yyyy" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true" name="date_filing" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="validationCustom05" class="form-label">POSITION</label>
                            <input name="position" type="text" class="form-control" id="validationCustom05"
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input name="salary" type="number" class="form-control" id="validationCustom05"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-daterange input-group" id="validationCustom01" data-date-format="M dd, yyyy" data-date-autoclose="true">
                                <input type="text" class="form-control" name="approved_by" placeholder="Approved by" required/>
