    ...
    <div class="col-10 mx-auto">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            @if (Auth::user()->is_admin == 1)
                <a style="padding: 5px 15px;" href="{{ route('cert.appearance.admin') }}" class="btn btn-primary btn-danger" type="button"><i class="fas fa-chevron-left"></i> Back</a>
            @else
                <a style="padding: 5px 15px;" href="{{ route('cert.appearance') }}" class="btn btn-primary btn-danger" type="button"><i class="fas fa-chevron-left"></i> Back</a>
            @endif
        </div>
    </div>
</div>
...
<div class="col-xl-10 mx-auto">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('store.cert.appearance') }}" method="POST" class="needs-validation">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-daterange input-group" id="datepicker6" data-date-format="M dd, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker6'>
                                <input type="text" class="form-control" name="date_start" placeholder="Start Date" />
                                <input type="text" class="form-control" name="date_end" placeholder="End Date" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="office" class="form-select" id="validationCustom04" required>
                                <option selected disabled value="">Office</option>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input name="venue" type="text" class="form-control" id="validationCustom05" placeholder="Venue" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="validationCustom05" class="form-label">Venue Address</label>
                            <input name="venue_address" type="text" class="form-control" id="validationCustom05"
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input name="purpose" type="text" class="form-control" id="validationCustom05" placeholder="Purpose" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="validationCustom05" class="form-label">Approved by</label>
                            <input name="approved_by" type="text" class="form-control" id="validationCustom05"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="designation" type="text" class="form-control" id="validationCustom05"
